...
namespace DietPlanner
{
    public partial class FormDataEntry : Form
    {
        ...
        {
            List<string> listBoxPrefferedItems = listBoxPreferred.Items.Cast<string>().ToList();
            List<string> listBoxAvoidedItems = listBoxAvoided.Items.Cast<string>().ToList();
            List<string> combinedList = listBoxPrefferedItems.Concat(listBoxAvoidedItems).Distinct().ToList();

            if (foodPreferences == null || foodPreferences.IsDisposed)
            {
                foodPreferences = new FormPreferences(foodsListBoxToFill, combinedList);
        ...
        private void btnSaveData_Click(object sender, EventArgs e)
        {
            ...
            string level = comboBoxActivityLevel.Text;
            string goal = comboBoxGoal.Text;
            ...
            try
            {
                ...
                connection.Open();
                string insertSQL = "INSERT INTO Patient(Patient_id, Name, Gender, Phone_number, Date_of_birth, Height, Weight, Activity_level, Goal) " +
        ...
        {
           // List<string> listBoxItems = listBoxPreferred.Items.Cast<string>().ToList();
